...
const CONTACT_OPTIONS = [
  ...
  value: 'info@ssinphinite.org business@madhwainfotech.com',
  href: 'mailto:info@ssinphinite.org,business@madhwainfotech.com',
  color: 'indigo',
},
  {
    icon: Globe,
    ...
    value: 'ERP GOODSYNK (click here)',
    href: 'https://www.goodsynk.com/erp',
    color: 'emerald',
  },
  {
    icon: Globe,
    title: 'GOODSYCK INVOICES',
    desc: 'Already using GOODSYCK INVOICES? Visit the app.',
    value: 'INVOICES GOODSYNK (click here)',
